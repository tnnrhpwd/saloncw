    ...
    <div className="links">
      <div className="links-appointments">
        <div className="links-appointments-text">
          Appointments are welcomed and optional. 
          Schedule an appointment now online or over-the-phone.
        </div>
        <a href="tel:9313596655">
          <button className="links-appointments-link">
            Phone#
          </button>
        </a>

        <a href="https://www.vagaro.com/saloncwcuts1/" rel="noreferrer" target="_blank">
          <button className="links-appointments-link">
            Vagaro
          </button>
        </a>
      ...
      <div className="links-profiles">
        <div className="links-profiles-div">
          <div className="links-profiles-div-btn">
            <a href="https://www.facebook.com/Salon-CW-Cuts-181126960232" rel="noreferrer" target="_blank">
          ...
          <div className="links-profiles-div-btn">
            <a href="https://www.instagram.com/SalonCWCuts" rel="noreferrer" target="_blank">
              <button className="links-profiles-div-btn-btn">
              Instagram
              </button>
            </a>
          ...
          <div className="links-profiles-div-btn">
            <a href="https://steviesboutique.com/" rel="noreferrer" target="_blank">
              <button className="links-profiles-div-btn-btn">
              Stevies Boutique
              </button>
            </a>
